...
author: "Miembros del grupo: \n\n\n **Daniel Casino** (dacaba4@alumni.uv.es), \n\n **Laura Borrás** (anesimar@alumni.uv.es) \n\n **Laura Albert** (nosan5@alumni.uv.es) \n\n Universitat de València"
...
Provincias_mayor<- dfDaniel %>% slice_max(Total, n = 4) 
provincias_point <- st_centroid(Provincias_mayor) #Cambiamos la geometry por el centroide
provincias_points <- cbind(Provincias_mayor, st_coordinates(st_centroid(Provincias_mayor$geometry))) %>% filter(NombreProv == c("Sevilla", "Madrid", "Barcelona"))
...
Provincias_mayor<- dfLaura %>% slice_max(Total, n = 4)
...
DATOS DE INE
- Datos nombres: https://www.ine.es/daco/daco42/nombyapel/nombres_por_edad_media.xls

- Datos apellidos: https://www.ine.es/daco/daco42/nombyapel/apellidos_frecuencia.xls
